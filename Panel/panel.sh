...
menu() {
    ...
    echo -e "${ORANGE}╚══════════════════════════════╝${RESET}"
    echo -e "${YELLOW}[01] 宝塔面板${RESET}"
    echo -e "${YELLOW}[02] 国际版宝塔${RESET}"
    echo -e "${YELLOW}[03] 开心版宝塔${RESET}"
    echo -e "${YELLOW}[04] 1Panel面板${RESET}"
    echo -e "${YELLOW}[05] 1Panel面板拓展应用${RESET}"
    echo -e "${YELLOW}[06] 1PanelV1开心版${RESET}"
    echo -e "${YELLOW}[07] 1PanelV2开心版${RESET}"
    echo -e "${YELLOW}[08] 耗子面板${RESET}"
    echo -e "${YELLOW}[09] PandaWiki文档${RESET}"
    echo -e "${YELLOW}[10] 雷池WAF${RESET}"
    echo -e "${YELLOW}[11] Halo博客${RESET}"
    echo -e "${YELLOW}[12] 个人主页${RESET}"
    echo -e "${YELLOW}[13] MomentsBlog${RESET}"
    echo -e "${YELLOW}[14] Flarum论坛${RESET}"
    echo -e "${YELLOW}[15] WordPress${RESET}"
