...
### 配置
```bash
https://raw.githubusercontent.com/sistarry/toolbox/refs/heads/main/Egern/EgernProfile.yaml
```
...
### 京东去广告
```bash
https://raw.githubusercontent.com/sistarry/toolbox/refs/heads/main/Egern/JDQG.yaml 
```
### 京东比价
```bash
