...
SUB_MENU[9]="90 Hermes Agent|91 OpenClaw|92 Akile优选DNS|93 自动机场签到|94 1panelapps管理|95 关闭哪吒监控SSH|96 状态检测|97 卸载探针"
...
execute_choice() {
    case "$1" in
        ...
        96) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/toy/test.sh) ;;
