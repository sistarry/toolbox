...
SUB_MENU[9]="90 Akile优选DNS|91 自动机场签到|92 1panelapps管理|93 关闭哪吒监控SSH|94 状态检测|95 卸载探针"
...
execute_choice() {
    case "$1" in
        ...
        94) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/toy/test.sh) ;;
