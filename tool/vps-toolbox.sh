...
SUB_MENU[9]="87 Alpine系统管理|89 甲骨文工具|90 文件目录备份|91 NAT小鸡|92 VPS监控通知|93 脚本短链|94 网站部署|95 关闭V1SSH|96 卸载哪吒Agent |97 卸载komariAgent|100 GProxy加速|101 Akile优先DNS"
...
execute_choice() {
    case "$1" in
        ...
        100) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/toy/GProxy.sh) ;;
        101) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/toy/AkileDNS.sh) ;;
        88)
