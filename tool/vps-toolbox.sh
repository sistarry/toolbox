...
SUB_MENU[9]="90 GProxy加速|91 Akile优选DNS|92 自动机场签到|93 1panelapps管理|94 关闭哪吒监控SSH|95 卸载探针"
...
execute_choice() {
    case "$1" in
        ...
        92) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/toy/JCQD.sh) ;;
        93) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/toy/1panelapps.sh) ;;
        ...
        95) bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/toy/unagent.sh) ;;
