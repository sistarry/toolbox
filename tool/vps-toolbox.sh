...
execute_choice() {
    case "$1" in
        ...
        49) bash <(curl -sL https://raw.githubusercontent.com/Polarisiu/toy/main/Networktool.sh) ;; 
        ...
        80) bash <(curl -fsSL https://raw.githubusercontent.com/Polarisiu/tool/main/group.sh) ;;
