...
case "$OS" in
    alpine)
        # 执行 Alpine 适配版脚本
        fetch_and_run "https://raw.githubusercontent.com/sistarry/toolbox/main/Alpine/APDNS.sh"
        ;;
    debian|ubuntu|centos|rocky|almalinux|fedora)
        # 执行原版脚本
        fetch_and_run "https://raw.githubusercontent.com/sistarry/toolbox/main/VPS/dns.sh"
        ;;
    *)  
        # 未能识别或暂不支持您的系统
        fetch_and_run "https://raw.githubusercontent.com/sistarry/toolbox/main/VPS/dns.sh"
