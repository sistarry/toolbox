...
GOST_SQL_URL="https://v6.gh-proxy.org/https://github.com/bqlpfy/flux-panel/releases/download/1.4.3/gost.sql"
...
menu() {
    while true; do
        ...
        case $choice in
            ...
            5) check_status ;;
            6) uninstall_app ;;
            7) curl -L https://v6.gh-proxy.org/https://raw.githubusercontent.com/bqlpfy/flux-panel/refs/heads/main/install.sh -o install.sh && chmod +x install.sh && ./install.sh ;;
            0) exit 0 ;;
