...
EOF
    ...
    echo -e "${GREEN}====================================================${RESET}"
    echo -e "${YELLOW}服务访问地址 : http://${DETECT_IP}:${custom_port}/v1/chat/completions ${RESET}"
...
show_info() {
    ...
    echo -e "${YELLOW}服务访问地址     : http://${DETECT_IP}:${webui_port}/v1/chat/completions ${RESET}"
    echo -e "${GREEN}====================================================${RESET}"
}
...
menu() {
    ...
    get_status_info
    echo -e "${GREEN}===================================${RESET}"
    echo -e "${GREEN}     ◈  MIMO-2API 管理面板  ◈     ${RESET}"
    echo -e "${GREEN}===================================${RESET}"
