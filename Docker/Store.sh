...
declare -A apps=(
    ...
    [11,23]="TelegramMusicBot音乐下载"
    [11,24]="RayNews新闻聚合阅读器"
    [12,1]="火宝短剧AI短剧生成"
    [12,2]="ONEAPI大模型资产管理"
    [12,3]="Grok2API"
    [12,4]="NEWAPI大模型资产管理"
...
declare -A commands=(
    ...
    [11,23]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/TelegramMusicBot.sh)'
    [11,24]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/RayNewsv.sh)'
