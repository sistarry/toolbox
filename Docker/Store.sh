...
declare -A apps=(
    ...
    [8,19]="Ech0             博客笔记"
    [8,20]="WebSSH           网页版SSH"
    [8,21]="ShadowSSH        网页版SSH" 
    [8,22]="Quick-SSH        终端SSH"
    [8,23]="DockUP           Docker更新通知"
    [8,24]="Watchtower       Docker自动更新"
    [9,1]="独角数卡        发卡系统"
    [9,2]="异次元商城      发卡系统"
    [9,3]="萌次元商城      发卡系统"
    [9,4]="Fakabot         发卡机器人"
...
declare -A commands=(
    ...
    [8,20]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/eooceWebSSH.sh)'
    [8,21]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/ShadowSSH.sh)'
    [8,22]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/Quick-SSH.sh)'
    [8,23]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/DockUP.sh)'
    [8,24]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/Watchtowertg.sh)'
