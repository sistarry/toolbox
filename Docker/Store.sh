...
declare -A commands=(
    ...
    [6,59]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/HuobaoDrama.sh)'
    ...
    [6,64]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/qbit-bot.sh)'
    ...
    [12,21]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/Grok2API.sh)'
    [12,22]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/DrissionPage.sh)'
