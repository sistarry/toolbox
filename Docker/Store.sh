...
declare -A apps=(
    ...
    [5,37]="Ech0笔记"
    [5,38]="WebSSHGateway"
    [5,39]="DockerCopilot容器管理工具"
    [5,40]="GiftWishlist礼物愿望清单"
    [5,41]="OutlookEmailPlus邮箱管理"
    [5,42]="OpenFlare CDN加速"
    [6,1]="koodoreader阅读"
    [6,2]="LrcApi音乐数据"
...
declare -A commands=(
    ...
    [5,39]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/DockerCopilot.sh)'
    [5,40]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/GiftList.sh)'
    [5,41]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/OutlookEmailPlus.sh)'
    [5,42]='bash <(curl -sL https://raw.githubusercontent.com/sistarry/toolbox/main/Docker/OpenFlare.sh)'
